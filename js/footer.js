...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (copyrightElement) {
        copyrightElement.innerHTML = `©2026 - ${currentYear} <i class="fa-fw fas fa-star fa-beat" style="color: #ffff00;"></i> By KagamiStarlight`;
    }
});
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (frameworkInfo) {
        frameworkInfo.innerHTML = '星镜馆已营业<span id="span_dt_dt"></span>';
    }
    showDateTime();
});   
